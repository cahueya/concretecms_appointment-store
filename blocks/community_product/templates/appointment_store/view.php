...
$view->requireAsset('appointment-store/flatpickr');
        ...
        <div class="store-product-details <?= $showImage ? 'col-md-6' : 'col-md-12' ?>">
            ...
            <div  class="store-product-options">
                ...
                foreach ($product->getOptions() as $option) {
                    // Appointment Store replaces its native Community Store text option
                    // with the CalDAV-backed picker. All other options use the original
                    // Community Store 2.6+ rendering below.
                    if ($option->getHandle() === 'appointment_slot') {
